...
const url = '../docs/history/history-1-30.pdf';
...
const setAudioAttribute = () => {
  ...
  // pageAudioId.setAttribute('onmouseover', `PlaySound('his-audio-${pageNum}')`);
  // pageAudioId.setAttribute('onmouseout', `StopSound('his-audio-${pageNum}')`);
