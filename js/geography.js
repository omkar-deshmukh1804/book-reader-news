...
/* PDF render */
const url = '../docs/geography/geography-1-20.pdf';
...
const setAudioAttribute = () => {
  ...
  // pageAudioId.setAttribute('onmouseover', `PlaySound('geo-audio-${pageNum}')`);
  // pageAudioId.setAttribute('onmouseout', `StopSound('geo-audio-${pageNum}')`);
